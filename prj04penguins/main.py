...
sns.boxplot(data=df, ax=axes[1, 0], x='species', y='body_mass_g')
sns.boxplot(data=df, ax=axes[1, 1], x='species', y='flipper_length_mm')
...
sns.barplot(data=df, x='species', y='body_mass_g', ax=axes[1], hue='sex')
